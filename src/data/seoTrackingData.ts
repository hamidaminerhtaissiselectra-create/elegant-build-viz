...
export const seoTrackingData: CityEntry[] = [
  ...
  { done: 'partial', region: "Auvergne-Rhône-Alpes", city: "Lyon", population: 519127, type: "Pilier", secondaryCities: "La Mulatière, Sainte-Foy-lès-Lyon, Villeurbanne, Caluire-et-Cuire, Écully, Oullins-Pierre-Bénite, Champagne-au-Mont-d'Or, Bron, Tassin-la-Demi-Lune, Saint-Fons, Francheville, Collonges-au-Mont-d'Or", notes: "Page existe, nearbyTowns incomplet vs Excel" },
  { done: 'partial', region: "Auvergne-Rhône-Alpes", city: "Saint-Étienne", population: 173136, type: "Pilier", secondaryCities: "La Ricamarie, Roche-la-Molière, Saint-Genest-Lerpt, Le Chambon-Feugerolles, Villars, Saint-Priest-en-Jarez, Saint-Jean-Bonnefonds, La Talaudière, Firminy, Unieux, La Fouillouse, Fraisses", notes: "Page existe, vérifier nearbyTowns" },
  { done: 'partial', region: "Auvergne-Rhône-Alpes", city: "Grenoble", population: 156140, type: "Pilier", secondaryCities: "Fontaine, La Tronche, Seyssinet-Pariset, Saint-Martin-le-Vinoux, Saint-Martin-d'Hères, Eybens, Échirolles, Seyssins, Corenc, Sassenage, Saint-Égrève, Gières", notes: "Page existe, vérifier nearbyTowns" },
